...
export default function CompareFertilityJurisdictionsPage() {
  return (
    <main className="max-w-4xl mx-auto px-6 py-16">
      ...
      <p className="text-[#6A6256] leading-relaxed">
        Age caps, marital status rules, documentation requirements,
        and cross-border acceptance all matter.
      </p>
      ...
      <p className="text-[#6A6256] leading-relaxed">
        Travel cadence, lab standards, clinic maturity, and continuity
        of care affect outcome probability.
      </p>
