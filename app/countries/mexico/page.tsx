...
/>
  ...
  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
    <Link href="/countries/united-states" className="border border-[#E5DDC8] p-6 rounded-xl hover:border-[#B89B5E] transition">
      ...
      <p className="text-sm text-[#6A6256] mt-2">Premium benchmark for breadth and capability in complex scenarios.</p>
    </Link>
    <Link href="/countries/canada" className="border border-[#E5DDC8] p-6 rounded-xl hover:border-[#B89B5E] transition">
      ...
      <p className="text-sm text-[#6A6256] mt-2">Governance-forward framework with tight ethical boundaries.</p>
    </Link>
    <Link href="/countries/turkey" className="border border-[#E5DDC8] p-6 rounded-xl hover:border-[#B89B5E] transition">
      ...
      <p className="text-sm text-[#6A6256] mt-2">Cross-continental private hospital infrastructure with cost advantages.</p>
    </Link>
  </div>
</section>
    </main>
