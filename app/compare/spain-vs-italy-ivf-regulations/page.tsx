...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical:
      "https://fertilitycarehub.com/compare/spain-vs-italy-ivf-regulations",
  },
};
    ...
    <main className="min-h-screen bg-[#F5F1E8] text-[#1A1A1A]">
      <div className="max-w-5xl mx-auto px-6 py-16">
            ...
            __html: JSON.stringify({
              ...
              itemListElement: [
                ...
                },
                {
                  "@type": "ListItem",
                  position: 3,
                  name: "Spain vs Italy IVF Regulations (2026)",
                  item: "https://fertilitycarehub.com/compare/spain-vs-italy-ivf-regulations",
                },
              ],
            }),
          }}
        ...
        <nav className="text-sm text-[#6A6256] mb-6" aria-label="Breadcrumb">
          ...
          <span className="mx-2">/</span>
          <span aria-current="page">Spain vs Italy</span>
        </nav>
