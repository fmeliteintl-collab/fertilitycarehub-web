...
export const metadata: Metadata = {
  title: "Spain vs Greece IVF Regulations (2026) | Cross-Border Fertility Comparison",
  description:
      ...
      <div className="max-w-5xl mx-auto px-6 py-16">
        ...
        <section className="mt-16">
          ...
          <p className="mt-4 text-[#6A6256] leading-relaxed">
            ...
            reproductive technologies, including defined donor anonymity provisions.
            Greece permits comparable treatment pathways within a regulatory framework
            that may involve procedural distinctions depending on case structure and
            eligibility profile.
          </p>
        </section>
        ...
        <section className="mt-12">
          ...
          <p className="mt-4 text-[#6A6256] leading-relaxed">
            ...
            international patients. Infrastructure concentration, laboratory capacity,
            and international familiarity vary by city and provider within each
            jurisdiction.
          </p>
        </section>
        ...
        <section className="mt-12">
          ...
          <p className="mt-4 text-[#6A6256] leading-relaxed">
            ...
            Greece permits donor-assisted pathways under defined governance parameters,
            with regulatory interpretation potentially influenced by pathway type and
        ...
        <section className="mt-12">
          ...
          <p className="mt-4 text-[#6A6256] leading-relaxed">
            Execution complexity in both jurisdictions depends on treatment pathway,
            documentation requirements, marital status, and coordination logistics.
            Operational friction varies more by case profile than by jurisdiction
            alone.
          </p>
        </section>
        ...
        <section className="mt-16 border-t border-[#E5DDC8] pt-12">
          ...
          <p className="mt-4 text-[#6A6256] leading-relaxed">
            Spain and Greece present structurally viable regulatory environments for
            cross-border fertility treatment. Suitability is contingent upon donor
            structure, storage horizon, citizenship exposure, financial planning,
